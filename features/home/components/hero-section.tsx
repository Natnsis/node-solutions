    ...
    <section className="relative overflow-hidden border-b border-border">
      ...
      <div className="container-main relative flex min-h-[88vh] flex-col items-center justify-center text-center">
        <div className="max-w-4xl">
          <p className="mb-4 inline-flex rounded-full border border-white/10 bg-white/5 px-4 py-1 text-xs uppercase tracking-[0.2em] text-primary backdrop-blur-sm">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            {tags.map((tag) => (
              <span
                key={tag}
                className="hero-chip rounded-md px-4 py-2 text-sm text-white shadow-card"
              >
                {tag}
              </span>
            ))}
