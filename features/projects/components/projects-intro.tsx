  ...
  return (
    <section className="container-main pt-12 md:pt-14">
      <div className="max-w-3xl">
        ...
        <div className="mt-6 inline-flex rounded-md border border-border bg-card px-4 py-2 text-sm text-foreground">
          Here&apos;s a selected portfolio of our notable works
        </div>
      </div>
    </section>
  );
